...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The Console log would not work as the variable "rando" was localised into the function Displaypics and thus no longer a global variable. This ment the console log caused confusion into the code as it looked for something it could not see.
...
if(localStorage.busmall){
  console.log('Local storage data exists allProducts = JSON.parse(localStorage.busmall');
} else {
