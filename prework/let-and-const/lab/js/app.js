...
function displayPics(){
  ...
  // According to the console log, it's because "rando" is not defined and is therefore breaking the code. Deconsting it resorted the images back to the page and removed the error!
  console.log(viewed);
