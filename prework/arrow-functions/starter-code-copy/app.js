...
// TODO: Uncomment the following line of code to see the output in the browser console
const listWords = ['hi', 'hello', 'are you there?']; // test
console.log('Hello from the old object function', oldObject(listWords));
...
//  - "this" pertains to the object that is instantiated.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  - "this" in this an arrow function pertains to the whole window object.
// 3. Explain why "this" is different when an arrow function is used.
//  - I imagine that arrow functions aren't made to handle "this" in the same way its used within an object constructor. It this will always pertain to the window object when it is within an arrow function.
