...
// The current object, so the Student.prototype.scope
// 2. What is "this" when joe.scopeArrow() is invoked?
// The specific object generated by the arrow function, so Student.prototype.scopeArrow
// 3. Explain why "this" is different when an arrow function is used.
// I believe the difference is that with the arrow function, you can get a more exact control over the object and what it's doing within the constuctor vs not using the scopeArrow and having the basic constructor be more out of scope or manipulated with less control. I would like to see examples of this more so I can better understand them and how they apply.
